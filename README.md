...
const conquistaLoteriasCaixa = {
  ...
  experiencia: "Utilizei a tecnologia dos NFTs colecionáveis para revolucionar a experiência dos usuários com as Loterias.",
  competencias: ["Next.js", "Blockchain", "Web3.js", "Trabalho em grupo", "Desenvolvimento de inovações", "Raciocínio lógico"],
};

const conquistaLaChain = {
  descricao: "1º Lugar do Desafio LaChain na DIGIFI Brasil, ago de 2023 - set de 2023",
  experiencia: "Desenvolvi, juntamente com minha equipe, a CredChain, uma plataforma de crédito, impulsionada pela tecnologia Hyperledger Besu.",
  desafio: "A LaChain nos desafiou a criar soluções DeFi inovadoras que impulsionassem a adoção de seu ecossistema.",
